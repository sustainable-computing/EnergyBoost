...
P_table = pd.read_csv('price_final.csv')[168:8760]
...
if __name__ == '__main__':
    ...
    pathlib.Path("mpc_hour/{}_4_mpc_hour".format(homeid)).mkdir(parents=True, exist_ok=True)
    csvfile = open("mpc_hour/{}_4_mpc_hour/sb".format(homeid)+str(int(float(sys.argv[1])*100))+"b"+str(int(float(sys.argv[2])*10))+".csv", 'w', newline='')

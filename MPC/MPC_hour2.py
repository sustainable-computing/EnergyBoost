...
if __name__ == '__main__':
    ...
    pathlib.Path("mpc_hour/{}_2_mpc_hour".format(homeid)).mkdir(parents=True, exist_ok=True)
    csvfile = open("mpc_hour/{}_2_mpc_hour/sb".format(homeid)+str(int(float(sys.argv[1])*100))+"b"+str(int(float(sys.argv[2])*10))+".csv", 'w', newline='')

...
class EnergyEnvironment:
    ...
    def __init__(self, max_charge_rate, mode="ground_truth", charge_mode="TOU", payment_cycle=24,datafile="test"):
        self.state = []
        ...
        self.action_space = spaces.Box(low=-self.max_charge_rate, high=self.max_charge_rate, shape=(1,), dtype=np.float32)

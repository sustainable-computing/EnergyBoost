...
for j in scenarios:
    ...
    csvfile = open('hourly_bill/panel2{}.csv'.format(j),'w', newline='')
    ...
    for i in hhids:
        ...
        #MPC
        nj=j[0:2]+'-'+j[2:]
        table = pd.read_csv('mpc_hour/{}_2_mpc_hour/{}.csv'.format(i,nj))
        ...
        #optimal bill
        table = pd.read_csv('opt_hour/{}_2_ophour/{}.csv'.format(i,nj))

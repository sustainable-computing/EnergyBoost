...
import math
import pathlib
from environment_simple import EnergyEnvironment
...
if __name__ == '__main__':
    if LOAD:
        ...
        pathlib.Path("simple_2/{}_2_simple".format(homeid)).mkdir(parents=True, exist_ok=True)
        csvfile = open("simple_2/{}_2_simple/sb".format(homeid)+str(int(float(sys.argv[1])*100))+"b"+str(int(float(sys.argv[2])*10))+".csv", 'w', newline='')

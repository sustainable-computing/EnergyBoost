...
if __name__ == '__main__':
    if LOAD:
        ...
        directory="{}_2_nosolar".format(homeid)
        if not os.path.exists(directory):
            os.makedirs(directory)
        csvfile = open("{}_2_nosolar/sb".format(homeid)+str(int(float(sys.argv[1])*100))+"b"+str(int(float(sys.argv[2])*10))+".csv", 'w', newline='')

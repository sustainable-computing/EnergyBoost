...
if __name__ == '__main__':
    if LOAD:
        ...
        pathlib.Path("rbc_2/{}_2_rbc".format(homeid)).mkdir(parents=True, exist_ok=True)
        csvfile = open("rbc_2/{}_2_rbc/sb".format(homeid)+str(int(float(sys.argv[1])*100))+"b"+str(int(float(sys.argv[2])*10))+".csv", 'w', newline='')
